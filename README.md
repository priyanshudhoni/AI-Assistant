This software uses speech recognition module "speech_recognition" to convert voice to text and uses pyttsx3 i.e python text to speech module to convert text to speech.
